...
<!---
* [**Pip installer:**](#pip) Choose this installation if you want to use AlphaQuant as a Python package in an existing python 3.9 environment (e.g. a Jupyter notebook). If needed, the GUI can be installed with pip as well.
-->
