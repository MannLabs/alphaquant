...
__all__ = ['run_pipeline', 'read_tables', 'benchmark_proteomics']
...
def run_pipeline(peptides_tsv, samplemap_tsv, pepheader = None, protheader = None, minrep = 2, outlier_correction = True, median_offset = False, pre_normed_intensity_file = None):
