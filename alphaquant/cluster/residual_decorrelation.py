...
# 1.0 down to -1.0 in steps of 0.1. The negative part is only reached when no
# cutoff meets the tolerance; the tightest value is then used, which prunes a
# parent down to residual_decorrelation_min_keep children.
