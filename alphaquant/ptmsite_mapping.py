# AUTOGENERATED! DO NOT EDIT! File to edit: 08_ptmsite_mapping.ipynb (unless otherwise specified).
...
__all__ = ['ModifiedPeptide', 'merge_samecond_modpeps', 'scale_site_idxs_to_protein', 'get_num_sites',
           ...
           'get_condensed_matrix', 'get_idmap_column', 'get_site_prob_overview', 'add_ptmsite_infos_spectronaut',
           'add_ptm_precursor_names_spectronaut', 'filter_input_table', 'headers_dicts', 'get_ptmpos_header',
           'get_ptmprob_header', 'assign_protein', 'assign_dataset', 'sequence_file', 'initialize_ptmsite_df',
...
sequence_file='uniprot_mapping.tsv', modification_type = "[Phospho (STY)]",sep = "\t", input_type = "Spectronaut"):
