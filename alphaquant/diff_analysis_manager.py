...
__all__ = ['run_pipeline', 'min_num_ions', 'use_iontree_if_possible', 'runtime_plots', 'write_ptm_mapped_input',
...
def run_pipeline(*,input_file = None, samplemap_file=None, input_df = None, samplemap_df = None, modification_type = None, results_dir = "./results", condpair_combinations = None, minrep = 2,
