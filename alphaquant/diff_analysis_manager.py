...
__all__ = ['run_pipeline', 'min_num_ions', 'use_iontree_if_possible', 'write_ptm_mapped_input',
           'check_input_consistency', 'get_unnormed_df_condpair', 'format_condpair_input', 'get_minrep_for_cond',
           'analyze_condpair', 'QuantifiedResult', 'update_quantified_proteins_w_tree_results', 'add_fdr',
           'get_results_df', 'write_out_normed_df', 'read_tables']
...
use_iontree_if_possible = True, get_ion2clust = False, median_offset = False, pre_normed_intensity_file = None, dia_fragment_selection = False, runtime_plots = False, volcano_fdr =0.05, volcano_fcthresh = 0.5, annotation_file = None):
...
def analyze_condpair(*,df_c1, df_c2, c1_samples, c2_samples, pep2prot, results_dir,condpair, minrep, min_num_ions, minpep,cluster_threshold_pval, cluster_threshold_fcfc, take_median_ion,outlier_correction, normalize, use_iontree_if_possible,
get_ion2clust,median_offset, pre_normed_intensity_file, dia_fragment_selection, runtime_plots, volcano_fdr, volcano_fcthresh, annotation_file, use_ml):
    ...
    if use_ion_tree:
        if use_ml:
            ml_performance_dict = {}
            aqclass.assign_predictability_scores(protnodes, results_dir, condpair, precursor_cutoff=3, fc_cutoff=0, number_splits=5, plot_predictor_performance=runtime_plots, replace_nans=True, performance_metrics=ml_performance_dict)
