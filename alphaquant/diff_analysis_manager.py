...
__all__ = ['run_pipeline', 'min_num_ions', 'use_iontree_if_possible', 'annotation_file', 'write_ptm_mapped_input',
...
annotation_file = None, protein_subset_for_normalization_file = None):
    ...
    with multiprocess.Pool(num_cores) as pool:
        ...
        analyze_condpair(samplemap_df=samplemap_df, input_df= input_df, input_file = input_file,results_dir=results_dir, condpair=condpair, minrep=minrep, min_num_ions=min_num_ions, minpep=minpep,
        ...
        use_iontree_if_possible=use_iontree_if_possible, write_out_results_tree = write_out_results_tree, get_ion2clust=get_ion2clust,median_offset=median_offset, pre_normed_intensity_file=pre_normed_intensity_file , dia_fragment_selection=dia_fragment_selection,
        runtime_plots=runtime_plots, volcano_fdr=volcano_fdr, volcano_fcthresh=volcano_fcthresh, annotation_file=annotation_file, use_ml = use_ml, protein_subset_for_normalization_file=protein_subset_for_normalization_file)
...
write_out_results_tree, get_ion2clust,median_offset, pre_normed_intensity_file, dia_fragment_selection, runtime_plots, volcano_fdr, volcano_fcthresh, annotation_file, use_ml, protein_subset_for_normalization_file):
    t_zero = time()
