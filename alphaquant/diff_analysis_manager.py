...
__all__ = ['run_pipeline_from_preconfigured_files', 'run_pipeline', 'get_ion2clust', 'format_condpair_input',
           'analyze_condpair', 'write_out_normed_df', 'read_tables']
...
def run_pipeline(unnormed_df, labelmap_df, results_dir = "./results",condpair_combinations = None, minrep = 2, min_num_ions = 1, minpep = 1, cluster_threshold_pval = 0.05, cluster_threshold_fcfc = 0, take_median_ion = True,outlier_correction = True, normalize = True, use_iontree_if_possible = True,
get_ion2clust = False, median_offset = False, pre_normed_intensity_file = None, dia_fragment_selection = False, runtime_plots = False, volcano_fdr =0.05, volcano_fcthresh = 0.5, annotation_file = None):
    ...
    for condpair in condpair_combinations:
        print(condpair)
        reformatted_input = format_condpair_input(labelmap_df, unnormed_df, condpair, minrep)
