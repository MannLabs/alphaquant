# AUTOGENERATED! DO NOT EDIT! File to edit: 16_diffresults_handling.ipynb (unless otherwise specified).

__all__ = ['QuantifiedMultiConditionComparison', 'QuantifiedProteinMultiCondition', 'QuantifiedProteinInCondpair',
           'QuantifiedProteinCanditateInCondpair', 'ResultsDirectoryReader', 'ResultsTableReader',
           'ResultstableLocalizer', 'ResultsFiles']
