...
__all__ = ['get_samples_used_from_samplemap', 'filter_df_to_minrep', 'get_condpairname', 'get_quality_scores',
           ...
           'get_levelnodes_from_nodeslist', 'write_chunk_to_file', 'set_logger', 'load_method_parameters',
...
def get_quality_scores(acquisition_info_df):
