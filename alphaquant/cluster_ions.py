...
__all__ = ['find_fold_change_clusters', 'find_fold_change_clusters_base_ions', 'exchange_cluster_idxs',
           'decide_cluster_order', 'predict_and_order_by_ml_score', 'propagate_and_order_by_ml_score',
           'get_node2clust_from_scored', 'get_fcs_ions', 'evaluate_distance', 'create_hierarchical_ion_grouping',
...
# Cell
def decide_cluster_order(node, childnode2clust, ml_classifier, featurenames_ml):
...
def get_node2clust_from_scored(clust2score, clust2nodes):
    ...
    for clustnum in range(len(clusts)):
        clust = clusts[clustnum]
