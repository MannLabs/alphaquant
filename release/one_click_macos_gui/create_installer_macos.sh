...
pip install "../../dist/alphaquant-0.1.0-py3-none-any.whl[stable]"
...
pkgbuild --root dist/alphaquant --identifier de.mpg.biochem.alphaquant.app --version 0.1.0 --install-location /Applications/alphaquant.app --scripts scripts alphaquant.pkg
