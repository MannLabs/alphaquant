...
pip install "../../dist/alphaquant-0.0.9-py3-none-any.whl[stable]"
...
pkgbuild --root dist/alphaquant --identifier de.mpg.biochem.alphaquant.app --version 0.0.9 --install-location /Applications/alphaquant.app --scripts scripts alphaquant.pkg
