...
pkgbuild --root dist/alphaquant --identifier de.mpg.biochem.alphaquant.app --version 0.0.7 --install-location /Applications/alphaquant.app --scripts scripts alphaquant.pkg
