...
pkgbuild --root dist/alphaquant --identifier de.mpg.biochem.alphaquant.app --version 0.0.8 --install-location /Applications/alphaquant.app --scripts scripts alphaquant.pkg
