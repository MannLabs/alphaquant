...
OutputDir=dist
OutputBaseFilename=alphaquant_gui_installer_windows
...
[Files]
Source: "dist\alphaquant_gui\{#MyAppExeName}"; DestDir: "{app}"; Flags: ignoreversion
Source: "dist\alphaquant_gui\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
